...
@onready var song_option_button = $VBoxContainer/HBoxContainer/SongOptionButton
@onready var difficulty_option_button = $VBoxContainer/HBoxContainer/DifficultyOptionButton
